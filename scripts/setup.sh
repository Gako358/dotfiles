...
function mkfs_worklaptop
{
  #Create partitions
  parted --script -a optimal /dev/nvme0n1p1 'mklabel gpt' & pid1=$!
  wait $pid1
  parted --script -a optimal /dev/nvme0n1p1 'mkpart efi 0% 512MiB' & pid2=$!
  wait $pid2
  parted --script -a optimal /dev/nvme0n1p1 'mkpart swap 512MiB 9.1GiB' & pid3=$!
  wait $pid3
  parted --script -a optimal /dev/nvme0n1p1 'mkpart nixos 9.1GiB 100%' & pid4=$!
  wait $pid4
  parted --script -a optimal /dev/nvme0n1p1 'set 1 boot on' & pid5=$!
  wait $pid5
...
function setup_worklaptop
{
  ...
  mount -o noatime,compress=zstd,ssd,space_cache=v2,subvol=home /dev/nvme0n1p3 /mnt/home
  mount -o noatime,compress=zstd,ssd,space_cache=v2,subvol=nix /dev/nvme0n1p3 /mnt/nix
  mount -o noatime,compress=zstd,ssd,space_cache=v2,subvol=var /dev/nvme0n1p3 /mnt/var
  mount -o noatime,compress=zstd,ssd,space_cache=v2,subvol=tmp /dev/nvme0n1p3 /mnt/tmp
