...
#+begin_src emacs-lisp
  ...
  ;; Must be set before evil or evil-collection loads (see evil-collection#60)
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-java
    ...
    :custom
    (lsp-java-server-install-dir (expand-file-name "~/.emacs.d/jdt-language-server/"))
  ...
  (use-package lsp-metals
    ...
    (lsp-register-custom-settings
     '(("metals.bloopInstall" "off")
       ("metals.defaultBspToBuildTool" t :json-false)))
...
#+begin_src emacs-lisp
  ...
  (use-package vue-ts-mode
    :hook ((vue-ts-mode . lsp-deferred)
  	   (vue-ts-mode . (lambda ()
  			    (setq-local lsp-disabled-clients '(ts-ls vue-semantic-server))
