...
#+begin_src emacs-lisp
  ...
  (use-package ben
    ...
    :config
    ;; Use a nerd-icons cube glyph in the mode-line status indicator.
    ;; `substring-no-properties' avoids rendering glitches when the icon is
    ;; propertized inside a composite mode-line construct.
    (with-eval-after-load 'nerd-icons
      (setq ben-indicator
            `(,(substring-no-properties (nerd-icons-faicon "nf-fa-cubes"))
              "[" (:eval (ben--status)) "]")))
