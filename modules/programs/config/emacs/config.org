...
#+begin_src emacs-lisp
  (use-package bivrost-theme
    ...
    (setq bivrost-italic t           ; Enable italic style
	  bivrost-bold t             ; Enable bold style
	  bivrost-underline t        ; Enable underline style
	  bivrost-underline-wave t   ; Use wave underline for warnings/errors
	  bivrost-italic-comments t  ; Make comments italic
	  bivrost-distinct-fringe t) ; Use distinct background for fringe

    (add-hook 'after-init-hook (lambda () (bivrost))))
#+end_src
