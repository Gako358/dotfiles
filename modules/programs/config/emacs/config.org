...
#+begin_src emacs-lisp
  ...
  (use-package cape
    ...
    :config
    ;; Set up evil-leader key bindings for Cape functions
    (evil-leader/set-key
      ;; Main completion commands
      "co" 'completion-at-point   ;; Main completion function
      "ct" 'complete-tag          ;; etags completion

      ;; Cape specific completions
      "cd" 'cape-dabbrev          ;; Word completion
      "cf" 'cape-file             ;; File path completion
      "ch" 'cape-history          ;; History completion
      "ck" 'cape-keyword          ;; Programming language keyword completion
      "cs" 'cape-elisp-symbol     ;; Elisp symbol completion
      "ce" 'cape-elisp-block      ;; Elisp block completion
      "ca" 'cape-abbrev           ;; Abbreviation completion
      "cl" 'cape-line             ;; Line completion
      "cw" 'cape-dict             ;; Dictionary word completion
      "c:" 'cape-emoji            ;; Emoji completion
      "c&" 'cape-sgml             ;; SGML/HTML completion
      "cr" 'cape-rfc1345))        ;; RFC 1345 completion
#+end_src
...
#+begin_src emacs-lisp
  (use-package copilot-chat
    :config
    (evil-leader/set-key
      "aa" 'copilot-chat-add-current-buffer
      "ad" 'copilot-chat-del-current-buffer
      "ae" 'copilot-chat-explain
      "af" 'copilot-chat-fix
      "ag" 'copilot-chat-insert-commit-message
      "ah" 'copilot-chat-hide
      "al" 'copilot-chat-list
      "aL" 'copilot-chat-list-refresh
      "am" 'copilot-chat-set-model
      "ar" 'copilot-chat-reset
      "av" 'copilot-chat-review
      "aV" 'copilot-chat-review-whole-buffer
